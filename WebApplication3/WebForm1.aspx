...
<div class="modal fade"  id="ins" role="dialog" data-backdrop="static">
        ...
        <div class="modal fade" id="bcd" role="dialog" data-backdrop="static">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <div class="modal fade" id="upd" role="dialog" data-backdrop="static" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
        ...
        <div class="modal fade" id="del" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='Provider=Microsoft.Jet.OLEDB.4.0;Data Source="C:\Users\rushi\Documents\Visual Studio 2012\Projects\WebApplication3\WebApplication3\Project.mdb"' ProviderName="System.Data.OleDb" SelectCommand="SELECT DISTINCT Pname FROM Pcode">
                                </asp:SqlDataSource>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString='Provider=Microsoft.Jet.OLEDB.4.0;Data Source="C:\Users\rushi\Documents\Visual Studio 2012\Projects\WebApplication3\WebApplication3\Project.mdb"' ProviderName="System.Data.OleDb" SelectCommand="SELECT DISTINCT Diameter FROM Product,Pcode WHERE Pcode.Pname=Product.Pname AND Product.Pname=@pname">
                                    <SelectParameters>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString='Provider=Microsoft.Jet.OLEDB.4.0;Data Source="C:\Users\rushi\Documents\Visual Studio 2012\Projects\WebApplication3\WebApplication3\Project.mdb"' ProviderName="System.Data.OleDb" SelectCommand="SELECT DISTINCT Length FROM Product,Pcode WHERE Pcode.Pname=Product.Pname AND Product.Diameter=@dia">
                                    <SelectParameters>
        ...
        <div class="modal fade" id="upd2" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="sea" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="rep1" role="dialog" data-backdrop="static">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="party_led" role="dialog" data-backdrop="static">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class='col-lg-7'>
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString='Provider=Microsoft.Jet.OLEDB.4.0;Data Source="C:\Users\rushi\Documents\Visual Studio 2012\Projects\WebApplication3\WebApplication3\Project.mdb"' ProviderName="System.Data.OleDb" SelectCommand="SELECT DISTINCT Cname FROM Supplier;">
                                </asp:SqlDataSource>
            ...
            <div class="modal fade" id="min_avl" role="dialog" data-backdrop="static">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
        ...
        <div class="modal fade" id="deadstk_result" role="dialog" data-backdrop="static">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
        ...
        <div class="modal fade" id="spl" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="cst" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="sal_inv" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="sid" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <asp:DropDownList ID="pname15" CssClass="form-control" runat="server" DataSourceID="SqlDataSource1" DataTextField="Pname" DataValueField="Pname" AutoPostBack="true" OnSelectedIndexChanged="pname15_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-5 control-label">DIAMETER</label>
                            <div class="col-lg-7">
                                <asp:DropDownList ID="dia15" CssClass="form-control" runat="server" DataSourceID="SqlDataSource15" DataTextField="Diameter" DataValueField="Diameter" AutoPostBack="true" OnSelectedIndexChanged="pname15_SelectedIndexChanged"></asp:DropDownList>
                                <asp:SqlDataSource ID="SqlDataSource15" runat="server" ConnectionString='Provider=Microsoft.Jet.OLEDB.4.0;Data Source="C:\Users\rushi\Documents\Visual Studio 2012\Projects\WebApplication3\WebApplication3\Project.mdb"' ProviderName="System.Data.OleDb" SelectCommand="SELECT DISTINCT Diameter FROM Product,Pcode WHERE Pcode.Pname=Product.Pname AND Product.Pname=@pname">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="pname15" Name="pname" PropertyName="SelectedValue" Type="String" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <asp:DropDownList ID="len15" CssClass="form-control" runat="server" DataSourceID="SqlDataSource16" DataTextField="Length" DataValueField="Length" AutoPostBack="true" OnSelectedIndexChanged="pname15_SelectedIndexChanged"></asp:DropDownList>
                                <asp:SqlDataSource ID="SqlDataSource16" runat="server" ConnectionString='Provider=Microsoft.Jet.OLEDB.4.0;Data Source="C:\Users\rushi\Documents\Visual Studio 2012\Projects\WebApplication3\WebApplication3\Project.mdb"' ProviderName="System.Data.OleDb" SelectCommand="SELECT DISTINCT Length FROM Product,Pcode WHERE Pcode.Pname=Product.Pname AND Product.Diameter=@dia">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="dia15" Name="dia" PropertyName="SelectedValue" Type="Int32" />
                                        <asp:ControlParameter ControlID="pname15" Name="pname" PropertyName="SelectedValue" Type="String" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            </div>
                ...
                <div class="form-group">
                    <label for="grade11" class="col-lg-5 control-label">Grade</label>
                    <div class="col-lg-7">
                        <asp:DropDownList ID="grade15" CssClass="form-control" runat="server">
                                <asp:ListItem Selected="True">8.8</asp:ListItem>
                                <asp:ListItem>10.9</asp:ListItem>
                                <asp:ListItem>12.9</asp:ListItem>
                            </asp:DropDownList>
                ...
                <div class="form-group">
                    <label for="plating11" class="col-lg-5 control-label">Plating</label>
                    <div class="col-lg-7">
                        <asp:DropDownList ID="plating15" CssClass="form-control" runat="server">
                                <asp:ListItem Selected="True">BLACK</asp:ListItem>
                                <asp:ListItem>WHITE</asp:ListItem>
                                <asp:ListItem>YELLOW</asp:ListItem>
                            </asp:DropDownList>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <asp:TextBox ID="qty15" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <asp:TextBox ID="rate15" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        
                        <div class="modal-footer">
                        <asp:button ID="sid_submit" CssClass="btn btn-primary" runat="server" OnClick="sid_submit_Click" Text="SUBMIT" />
                        <asp:button ID="sid_pdf" CssClass="btn btn-primary" runat="server" OnClick="sid_pdf_Click" Text="PDF" />
                    </div>
                </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="sal_odr" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="sod" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        <h4>SALES ORDER DETAILS<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button></h4>
                ...
                <div class="form-group">
                    <label for="grade11" class="col-lg-5 control-label">Grade</label>
                    <div class="col-lg-7">
                        <asp:DropDownList ID="grade11" CssClass="form-control" runat="server">
                                <asp:ListItem Selected="True">8.8</asp:ListItem>
                                <asp:ListItem>10.9</asp:ListItem>
                                <asp:ListItem>12.9</asp:ListItem>
                            </asp:DropDownList>
                ...
                <div class="form-group">
                    <label for="plating11" class="col-lg-5 control-label">Plating</label>
                    <div class="col-lg-7">
                        <asp:DropDownList ID="plating11" CssClass="form-control" runat="server">
                                <asp:ListItem Selected="True">BLACK</asp:ListItem>
                                <asp:ListItem>WHITE</asp:ListItem>
                                <asp:ListItem>YELLOW</asp:ListItem>
                            </asp:DropDownList>
        ...
        <div class="modal fade" id="pur_odr" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="pod" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                ...
                <div class="form-group">
                    <label for="grade13" class="col-lg-5 control-label">Grade</label>
                    <div class="col-lg-7">
                        <asp:DropDownList ID="grade13" CssClass="form-control" runat="server">
                                <asp:ListItem Selected="True">8.8</asp:ListItem>
                                <asp:ListItem>10.9</asp:ListItem>
                                <asp:ListItem>12.9</asp:ListItem>
                            </asp:DropDownList>
                ...
                <div class="form-group">
                    <label for="plating13" class="col-lg-5 control-label">Plating</label>
                    <div class="col-lg-7">
                        <asp:DropDownList ID="plating13" CssClass="form-control" runat="server">
                                <asp:ListItem Selected="True">BLACK</asp:ListItem>
                                <asp:ListItem>WHITE</asp:ListItem>
                                <asp:ListItem>YELLOW</asp:ListItem>
                            </asp:DropDownList>
        ...
        <div class="modal fade" id="spl_name" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        <h4>SUPPLIER DETAILS<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button></h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="col-lg-5 control-label">SUPPLIER NAME</label>
                            <div class="col-lg-7">
                                <asp:DropDownList ID="spl14" CssClass="form-control" runat="server" DataSourceID="SqlDataSource3" DataTextField="Cname" DataValueField="Cname">
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString='Provider=Microsoft.Jet.OLEDB.4.0;Data Source="C:\Users\rushi\Documents\Visual Studio 2012\Projects\WebApplication3\WebApplication3\Project.mdb"' ProviderName="System.Data.OleDb" SelectCommand="SELECT Cname FROM Supplier">
                                </asp:SqlDataSource>
                            </div>
                        </div>
                        
                    <div class="modal-footer">
                        <asp:button ID="spl_name_submit" CssClass="btn btn-primary" runat="server" OnClick="spl_name_submit_Click" Text="SUBMIT" />
                    </div>
                </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="cst_name" role="dialog" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                    <div class="modal-header">
                        <h4>CUSTOMER DETAILS<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button></h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="col-lg-5 control-label">CUSTOMER NAME</label>
                            <div class="col-lg-7">
                                <asp:DropDownList ID="cst15" CssClass="form-control" runat="server" DataSourceID="SqlDataSource4" DataTextField="Cname" DataValueField="Cname">
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString='Provider=Microsoft.Jet.OLEDB.4.0;Data Source="C:\Users\rushi\Documents\Visual Studio 2012\Projects\WebApplication3\WebApplication3\Project.mdb"' ProviderName="System.Data.OleDb" SelectCommand="SELECT Cname FROM Customer">
                                </asp:SqlDataSource>
                            </div>
                        </div>
                        
                    <div class="modal-footer">
                        <asp:button ID="cst_name_submit" CssClass="btn btn-primary" runat="server" OnClick="cst_name_submit_Click" Text="SUBMIT" />
                    </div>
                </div>
                </div>
            </div>
