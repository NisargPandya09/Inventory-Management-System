    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void insertSubmit_Click(object sender, EventArgs e)                    /*Method for the operation when submit button is clicked in insert form*/ 
        {
            try
            {
                ...
                con = new OdbcConnection("DSN=Project");
                con.Open();
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "My Script", "confirm('Sorry, there is some invalid data. Try again...');", true);
            }
        }
        ...
        protected void upd_update_Click(object sender, EventArgs e)                      /*Method to update information of any product*/ 
        {
            try
            {
                OdbcConnection con1 = new OdbcConnection("DSN=Project");
                con1.Open();
        ...
        protected void rep1_purchase_Click(object sender, EventArgs e)
        {
            ...
            cmd1.CommandText = "SELECT Pname as Product,Diameter,Length,Product.Plating,Product.Grade,SUM(Quantity),SUM(Payment_Amount),Cname,MONTH(Order_date) FROM Purchase_order,Purchase_Order_Details,Customer,Product WHERE Purchase_Order_Details.Order_id=Purchase_order.Order_id AND Purchase_Order_Details.Prcode=Product.Prcode AND Purchase_Order_Details.Plating=Product.Plating AND Purchase_Order_Details.Grade=Product.Grade AND Customer.Cid=Purchase_order.Cid AND Purchase_order.Order_date BETWEEN #" + D1 + "# AND #" + D2 + "# GROUP BY MONTH(Order_date),Purchase_Order_Details.Prcode,Customer.Cname,Product.Plating,Product.Grade,Product.Length,Product.Diameter,Product.Pname;";
            cmd1.Connection = con;
            OdbcDataReader dr = cmd1.ExecuteReader();
            Response.Write("<div class=\"modal\" id=\"pur_rep_result\" data-show=\"true\">");
            Response.Write("<div class=\"modal-dialog modal-lg\">");
            Response.Write("<div class=\"modal-content\">");
            Response.Write("<div class=\"modal-header\">");
            Response.Write("<h4>PURCHASE REPORT<button type=\"button\" class=\"close\" data-dismiss=\"modal\"><span aria-hidden=\"true\">&times;</span><span class=\"sr-only\">Close</span></button></h4></div>");
            Response.Write("<div class=\"modal-body\"> ");
            Response.Write("<Table class=\"table table-bordered table-striped\">");
            Response.Write("<tr>");
            Response.Write("<th>Product Name</th>");
            ...
            while (dr.Read())
            {
                ...
                Response.Write("<Td>" + dr.GetString(5) + "</td>");
                Response.Write("<Td>" + dr.GetString(6) + "</td>");
                Response.Write("<Td>" + dr.GetString(7) + "</td>");
                Response.Write("<Td>" + dr.GetString(8) + "</td>");
                Response.Write("</Tr>");
            }
            ...
            dr.Read();
            con.Close();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "pop", "openpurrep_resModal();", true);
            }
            catch (Exception ex)
            {
               ScriptManager.RegisterStartupScript(this, this.GetType(), "My Script", "confirm('Sorry, there is some invalid data. Try again...');", true);
        ...
        protected void rep1_sales_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OdbcCommand cmd1 = new OdbcCommand();
                cmd1.CommandText = "SELECT Pname as Product,Diameter,Length,Product.Plating,Product.Grade,SUM(Quantity),SUM(Amount),Cname,MONTH(Order_date) FROM Sales_order,Sales_Details,Supplier,Product WHERE Sales_Details.Order_id=Sales_order.Order_id AND Sales_Details.Prcode=Product.Prcode AND Sales_Details.Plating=Product.Plating AND Sales_Details.Grade=Product.Grade AND Supplier.Cid=Sales_order.Cid AND Sales_order.Order_date BETWEEN #" + D1 + "# AND #" + D2 + "# GROUP BY MONTH(Order_date),Supplier.Cname,Product.Plating,Product.Grade,Product.Length,Product.Diameter,Product.Pname;";
                cmd1.Connection = con;
                OdbcDataReader dr = cmd1.ExecuteReader();
                Response.Write("<div class=\"modal\" id=\"sal_rep_result\" data-show=\"true\">");
                Response.Write("<div class=\"modal-dialog modal-lg\">");
                Response.Write("<div class=\"modal-content\">");
                Response.Write("<div class=\"modal-header\">");
                ...
                dr.Read();
                con.Close();
                ScriptManager.RegisterStartupScript(this, this.GetType(), "pop", "opensalrep_resModal();", true);
            }
            catch (Exception ex)
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "My Script", "confirm('Sorry, there is some invalid data. Try again...');", true);
        ...
        protected void in_submit_Click(object sender, EventArgs e)
        {
            ...
            /*String invoice = invoice_no.Text;
            Int32 oid = Convert.ToInt32(order_no.Text);
            DateTime inv_date = Convert.ToDateTime(date.Text);
            String top = term.Text;
            String desno = doc_no.Text;
            String sref = s_ref.Text;
            String oref = other.Text;
            String des_th = despatched.Text;
            String del = del_note.Text;
            DateTime desdate = Convert.ToDateTime(des_date.Text);
            String vno = v_no.Text;
            String dest = destination.Text;
            Int32 amt = Convert.ToInt32(quantity.Text);
            //OdbcCommand cmd2 = new OdbcCommand("insert into Invoices values(?,?)", con);*/
            OdbcCommand cmd = new OdbcCommand("insert into Invoices values(?,?,?,?,?,?,?,?,?,?,?,?)", con);
            cmd.Parameters.Add(new OdbcParameter("Invoice_no", in_num9.Text));
            cmd.Parameters.Add(new OdbcParameter("Order_ID", in_odno9.Text));
            cmd.Parameters.Add(new OdbcParameter("Invoice_Date", in_date9.Text));
            cmd.Parameters.Add(new OdbcParameter("Terms_of_Payment", in_toc9.Text));
            cmd.Parameters.Add(new OdbcParameter("Delivery_note", in_dnot9.Text));
            cmd.Parameters.Add(new OdbcParameter("Despatched_doc_no", in_ddoc9.Text));
            cmd.Parameters.Add(new OdbcParameter("Supplier_ref", in_sref9.Text));
            cmd.Parameters.Add(new OdbcParameter("Other_ref", in_oref9.Text));
            cmd.Parameters.Add(new OdbcParameter("Despatched_through", in_dth9.Text));
            cmd.Parameters.Add(new OdbcParameter("Despatched_date", in_ddate9.Text));
            cmd.Parameters.Add(new OdbcParameter("Motor_vehicle_no", in_vno9.Text));
            cmd.Parameters.Add(new OdbcParameter("Destination", in_des9.Text));
            
            //cmd2.Parameters.AddWithValue("@Invoice_no", invoice);
            //cmd2.Parameters.AddWithValue("@Order_ID", oid);
            int n = cmd.ExecuteNonQuery();
            con.Close();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "pop", "opensidModal();", true);
        ...
        protected void sod_submit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OdbcCommand cmd1 = new OdbcCommand("select * from Product where Prcode=? AND Plating=? AND Grade=?", con);
                cmd1.Parameters.Add(new OdbcParameter("Prcode", code));
                cmd1.Parameters.Add(new OdbcParameter("Plating", plating11.Text));
                cmd1.Parameters.Add(new OdbcParameter("Grade", grade11.Text));
                OdbcDataReader dr = cmd1.ExecuteReader();
                if (dr.Read())
                {
                    ...
                    cmd.Parameters.Add(new OdbcParameter("Prcode", code));
                    cmd.Parameters.Add(new OdbcParameter("Plating", plating11.Text));
                    cmd.Parameters.Add(new OdbcParameter("Grade", Convert.ToDouble(grade11.Text)));
                    ...
                    cmd.Parameters.Add(new OdbcParameter("Per", Convert.ToInt32(per11.Text)));
                    int n = cmd.ExecuteNonQuery();
                    id11++;
                    pname11.Text = "";
                    dia11.Text = "";
        ...
        protected void pur_odr_submit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.Parameters.Add(new OdbcParameter("Order_id", p));
                cmd.Parameters.Add(new OdbcParameter("Cid", cid));
        ...
        protected void pod_submit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OdbcCommand cmd1 = new OdbcCommand("select * from Product where Prcode=? AND Plating=? AND Grade=?", con);
                cmd1.Parameters.Add(new OdbcParameter("Prcode", code));
                cmd1.Parameters.Add(new OdbcParameter("Plating", plating13.Text));
                cmd1.Parameters.Add(new OdbcParameter("Prcode", grade13.Text));
                OdbcDataReader dr = cmd1.ExecuteReader();
                if (dr.Read())
                {
                    ...
                    cmd.Parameters.Add(new OdbcParameter("Prcode", code));
                    cmd.Parameters.Add(new OdbcParameter("Plating", plating13.Text));
                    cmd.Parameters.Add(new OdbcParameter("Grade", Convert.ToDouble(grade13.Text)));
        ...
        protected void minavl_Click(object sender, EventArgs e)
        {
           try{
            ...
            OdbcConnection con = new OdbcConnection("DSN=Project");
            con.Open();
            OdbcCommand cmd = new OdbcCommand("select Pname,Cname,Diameter,Length,Grade,Plating,Availability,Min_Availability from Product,Supplier where Product.Cid=Supplier.Cid AND Availability <= Min_Availability",con);
            OdbcDataReader dr = cmd.ExecuteReader();
            dt = new DataTable();
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    if (dr1.HasRows)
                    {
                        ...
                        {
                            dt.Rows.Add();
                            dt.Rows[i]["Product"] = dr1.GetInt32(0);
                            dt.Rows[i]["Company"] = dr1.GetInt32(1);
        ...
        protected void pname15_SelectedIndexChanged(object sender, EventArgs e)
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "pop", "opensidModal();", true);
        }
        ...
        protected void spl_name_submit_Click(object sender, EventArgs e)
        {
            try
            {
                con = new OdbcConnection("DSN=Project");
                String cn = spl14.SelectedValue;
                con.Open();
                OdbcCommand cmd = new OdbcCommand("select * from Supplier where Cname= '" + cn + "';", con);
                OdbcDataReader dr = cmd.ExecuteReader();
                Response.Write("<div class=\"modal fade\" id=\"spl_result\" role=\"dialog\" data-backdrop=\"static\">");
                Response.Write("<div class=\"modal-dialog\">");
                Response.Write("<div class=\"modal-content\">");
                Response.Write("<div class=\"modal-header\">");
                Response.Write("<h4>SUPPLIER DETAILS<button type=\"button\" class=\"close\" data-dismiss=\"modal\"><span aria-hidden=\"true\">&times;</span><span class=\"sr-only\">Close</span></button></h4></div>");
                Response.Write("<div class=\"modal-body\"> ");
                Response.Write("<table class=\"table table-bordered table-striped\">");

                Response.Write("<tr><th>Company Name</th><th>Address</th><th>Email</th><th>PHONE NO.</th></tr>");

                while (dr.Read())
                {
                    Response.Write("<tr>");
                    Response.Write("<td>" + dr["Cname"] + "</td>");
                    Response.Write("<td>" + dr["Address"] + "</td>");
                    Response.Write("<td>" + dr["Email"] + "</td>");
                    Response.Write("<td>" + dr["Phone no"] + "</td>");
                    //  htmlTable.Append("<td>" + dr["Diameter"] + "</td>");
                    Response.Write("</tr>");
                    Response.Write("</table>");
                    Response.Write("</div>");
                    Response.Write("<div class=\"modal-footer\" ");
                    Response.Write("<asp:button ID=\"spl_result_OK\" CssClass=\"btn btn-primary\" runat=\"server\" Text=\"OK\" /> ");
                    Response.Write("</div>");
                    Response.Write("</div>");
                    Response.Write("</div>");
                    Response.Write("</div>");
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "pop", "spl_result_modal();", true);
                }
                dr.Close();
                con.Close();
            }
        ...
        protected void cst_name_submit_Click(object sender, EventArgs e)
        {
            try
            {
                con = new OdbcConnection("DSN=Project");
                String cn = cst15.SelectedValue;
                con.Open();
                OdbcCommand cmd = new OdbcCommand("select * from Customer where Cname='" + cn + "';", con);
                OdbcDataReader dr = cmd.ExecuteReader();
                Response.Write("<div class=\"modal fade\" id=\"cst_result\" role=\"dialog\" data-show=\"true\">");
                Response.Write("<div class=\"modal-dialog\">");
                Response.Write("<div class=\"modal-content\">");
                Response.Write("<div class=\"modal-header\">");
                Response.Write("<h4>CUSTOMER DETAILS<button type=\"button\" class=\"close\" data-dismiss=\"modal\"><span aria-hidden=\"true\">&times;</span><span class=\"sr-only\">Close</span></button></h4></div>");
                Response.Write("<div class=\"modal-body\"> ");
                Response.Write("<table class=\"table table-bordered table-striped\">");

                Response.Write("<tr><th>Company Name</th><th>Address</th><th>Email</th><th>Phone no</th><th>CST</th><th>VAT</th></tr>");
                ...
                while (dr.Read())
                {
                    ...
                    Response.Write("<td>" + dr["Email"] + "</td>");
                    Response.Write("<td>" + dr["Phone no"] + "</td>");
                    Response.Write("<td>" + dr["CST"] + "</td>");
                    Response.Write("<td>" + dr["VAT"] + "</td>");
                    //  htmlTable.Append("<td>" + dr["Diameter"] + "</td>");
                    Response.Write("</tr>");
                    Response.Write("</table>");
                    Response.Write("</div>");
                    Response.Write("<div class=\"modal-footer\" ");
                    Response.Write("<asp:button ID=\"cst_result_OK\" CssClass=\"btn btn-primary\" runat=\"server\" Text=\"OK\" /> ");
                    Response.Write("</div>");
                    Response.Write("</div>");
                    Response.Write("</div>");
                    Response.Write("</div>");

                    ScriptManager.RegisterStartupScript(this, this.GetType(), "pop", "cst_result_modal();", true);
                }
                dr.Close();
                con.Close();
            }
        ...
        protected void sid_submit_Click(object sender, EventArgs e)
        {
            //try
            {
                OdbcConnection con = new OdbcConnection("DSN=Project");
                con.Open();
                prcode pr = new prcode();
                Int32 code = pr.getcode(pname15.Text, Convert.ToInt32(dia15.Text), Convert.ToInt32(len15.Text));
                OdbcCommand cmd1 = new OdbcCommand("select * from Product where Prcode=? AND Plating=? AND Grade=?", con);
                cmd1.Parameters.Add(new OdbcParameter("Prcode", code));
                cmd1.Parameters.Add(new OdbcParameter("Plating", plating15.Text));
                cmd1.Parameters.Add(new OdbcParameter("Grade", grade15.Text));
                OdbcDataReader dr = cmd1.ExecuteReader();
                if (dr.Read())
                {
                    OdbcCommand cmd = new OdbcCommand("insert into Invoice_Details values(?,?,?,?,?,?,?,?,?,?,?,?,?)", con);
                    cmd.Parameters.Add(new OdbcParameter("ID", id17));
                    cmd.Parameters.Add(new OdbcParameter("Invoice_no", in_num9.Text));
                    cmd.Parameters.Add(new OdbcParameter("Prcode", code));
                    cmd.Parameters.Add(new OdbcParameter("Plating", plating15.Text));
                    cmd.Parameters.Add(new OdbcParameter("Grade", Convert.ToDouble(grade15.Text)));
                    cmd.Parameters.Add(new OdbcParameter("Quantity", Convert.ToInt32(qty15.Text)));
                    cmd.Parameters.Add(new OdbcParameter("Rate", Convert.ToInt32(rate15.Text)));
                    cmd.Parameters.Add(new OdbcParameter("Amount", Convert.ToInt32(rate15.Text) * Convert.ToInt32(qty15.Text)));
        ...
        protected void sid_pdf_Click(object sender, EventArgs e)
        {
            try
            {
